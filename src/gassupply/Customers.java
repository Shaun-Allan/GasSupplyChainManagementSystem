...
public class Customers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cid_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        cid_tf.setToolTipText("");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(cid_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try{
            String sql = "select * from Customers where customer_id = '" + cid_tf.getText()+ "'";
    ...
    private void insertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButtonActionPerformed
        ...
        try{
            ...
            ps.setString(1, cid_tf.getText());
            ps.setString(2, name_tf.getText());
            ps.setString(3, lorder_tf.getText());
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "delete from Customers where customer_id = '" + cid_tf.getText()+ "'";
            st = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            st.executeQuery(sql);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE Customers SET name = ?, last_order = ?, contact_number = ? WHERE customer_id = ?";
            ps = con.prepareStatement(sql);
    
    // Set parameters
            ps.setString(1, name_tf.getText());
            ps.setString(2, lorder_tf.getText());
            ps.setInt(3, Integer.parseInt(contact_tf.getText()));
            ps.setString(4, cid_tf.getText());
    ...
    // Execute the update
            ...
            JOptionPane.showMessageDialog(this, "Invalid contact no value. Please enter a valid number.");
        }
