...
public class Process extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        prodid_tf = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        pcid_tf = new javax.swing.JTextField();
        ...
        edate_tf = new javax.swing.JTextField();
        ...
        prodid_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        prodid_tf.setToolTipText("");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("Process");

        pcid_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        pcid_tf.setToolTipText("");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setText("Process Facility ID");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setText("Refinery ID");

        rid_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        rid_tf.setToolTipText("");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel5.setText("Processing Start Date");

        sdate_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        sdate_tf.setToolTipText("");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel6.setText("Processing End Date");

        edate_tf.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        edate_tf.setToolTipText("");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel7.setText("Amount of Natural Gas");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addComponent(prodid_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(pcid_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(edate_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(prodid_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(pcid_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(edate_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(prodid_tf.getText().equals("") || pcid_tf.getText().equals("") || rid_tf.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Fill all the IDs to retrieve data");
            return;
        }
        try{
            String sql = "select * from Process where processing_facility_id = '" + pcid_tf.getText()+ "' and production_id = '" + prodid_tf.getText() + "' and refinery_id = '" + rid_tf.getText() + "'" ;
            ...
            if(rs.next()){
                ...
                String sDateStr = rs.getString(4);
                String eDateStr = rs.getString(5);
                ...
                edate_tf.setText(eFormattedDate);
                amt_tf.setText(rs.getString(6));
            }
            else{
    ...
    private void insertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButtonActionPerformed
        ...
        try{
            ...
            ps.setString(2, prodid_tf.getText());
            ps.setString(1, pcid_tf.getText());
            ps.setString(3, rid_tf.getText());
            ps.setString(4, sdate_tf.getText());
            ps.setString(5, edate_tf.getText());
            ps.setFloat(6, Float.parseFloat(amt_tf.getText()));
            ps.execute();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        if(prodid_tf.getText().equals("") || pcid_tf.getText().equals("") || rid_tf.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Fill all the IDs to delete data");
            return;
        }
        try{
            String sql = "delete from Process where processing_facility_id = '" + pcid_tf.getText()+ "' and production_id = '" + prodid_tf.getText() + "' and refinery_id = '" + rid_tf.getText() + "'" ;
            st = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            st.executeQuery(sql);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE Process SET processing_start_date = ?, processing_end_date = ?, amount_of_natural_gas = ? where processing_facility_id = ? and production_id = ? and refinery_id = ?" ;
            ps = con.prepareStatement(sql);
    
    // Set parameters
            ps.setString(1, sdate_tf.getText());
            ps.setString(2, edate_tf.getText());
            ps.setFloat(3, Float.parseFloat(amt_tf.getText()));
            ps.setString(4, pcid_tf.getText());
            ps.setString(5, prodid_tf.getText());
            ps.setString(6, rid_tf.getText());
    ...
    private javax.swing.JTextField edate_tf;
    ...
    private javax.swing.JTextField pcid_tf;
    private javax.swing.JTextField prodid_tf;
